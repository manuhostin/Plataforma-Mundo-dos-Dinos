const dinossauros = [
  {
    ...
    peso: '30 t',
    descricao: 'Sauropoda brasileiro de grande porte, com pescoço longo e corpo robusto. Descoberto em rochas da Formação Adamantina no estado de São Paulo.',
    curiosidades: 'Seu nome homenageia a cidade de Adamantina (SP) e os titãs da mitologia grega. É um dos maiores titanossauros conhecidos do Brasil.',
    imagem: '',
    coords: [-21.6825, -51.0731], // Adamantina, SP
  },
  {
    id: 2,
    ...
    peso: '3,5 kg',
    descricao: 'Pequeno dinossauromorfo do Triássico, com corpo leve e adaptado para correr. Descoberto em rochas da Formação Santa Maria em 2024.',
  ...
  },
  {
    ...
    imagem: '',
    coords: [-5.0892, -45.0000], // Região do Maranhão
  },
  {
    id: 4,
  ...
  },
  {
    ...
    dieta: 'Herbívoro',
    local: 'Formação Adamantina, Grupo Bauru, São Paulo',
    familia: 'Megaraptora (Titanosauria)',
  ...
  },
  {
    ...
    curiosidades: 'O nome homenageia o Grupo Bauru (formação geológica onde foi encontrado) e o paleontólogo Diógenes de Almeida Campos Brito. Uberaba é um dos principais polos paleontológicos do Brasil.',
    imagem: '',
  ...
  },
  {
    ...
    imagem: '',
    coords: [-24.0000, -52.0000], // Região do Paraná
  },
  {
    id: 11,
